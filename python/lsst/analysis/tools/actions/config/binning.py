...
__all__ = ("MagnitudeBinnedMetricsConfig",)

import lsst.pex.config as pexConfig


class MagnitudeBinnedMetricsConfig(pexConfig.Config):
    ...
    def get_bins(self):
        return list(range(self.mag_low_min, self.mag_low_max, self.mag_interval))
