...
class MagnitudeTool(ObjectClassTool):
    ...
    fluxes_default = FluxesDefaultConfig(
        ...
        kron_err=FluxConfig(
            ...
            key_flux_error="{band}_kronFluxErr",
            name_flux="Kron",
            name_flux_short="kron",
        ),
        psf_err=FluxConfig(
...
class SizeTool(ObjectClassTool):
    ...
    sizes_default = SizeDefaultConfig(
        bulge=SizeConfig(key_size="{band}_cModel_dev_reff_major", name_size="CModel Bulge $R_{eff}$",
                         has_moments=False),
        disk=SizeConfig(key_size="{band}_cModel_exp_reff_major", name_size="CModel Disk $R_{eff}$",
                        has_moments=False),
        moments=SizeConfig(key_size="{band}_i{suffix}", name_size="Second moment radius"),
        sersic=SizeConfig(key_size="sersic_reff_major", name_size="Sérsic $R_{eff,major}$",
                          has_moments=False),
