...
from ..actions.scalar.scalarActions import MagPercentileAction, MedianAction, SigmaMadAction
...
class CompletenessPurityTool(AnalysisTool):
    ...
    def setDefaults(self):
        ...
        self.process.calculateActions.mag50 = MagPercentileAction()
        self.process.calculateActions.mag50.vectorKey = "ref_{band}_flux"
        self.process.calculateActions.mag50.matchDistanceKey = "match_distance"

        self.process.calculateActions.mag20 = MagPercentileAction(percentile=20.0)
        self.process.calculateActions.mag20.vectorKey = "ref_{band}_flux"
        self.process.calculateActions.mag20.matchDistanceKey = "match_distance"
...
class TargetInjectedCatDelta(AnalysisTool):
    ...
    def coaddContext(self) -> None:
        ...
        self.process.calculateActions.stars.highSNSelector.threshold = 1000
