...
class InjectedObjectAnalysisConnections(
    ...
    defaultTemplates={
        "targetCatalog": "injected_objectTable_tract",
        "refCatalog": "injected_deepCoadd_catalog_tract",
        "outputName": "injected_objectTable_tract_injected_deepCoadd_catalog_tract_match",
    },
):
    data = ct.Input(
