...
__all__ = ("SimpleTableAnalysisConfig", "SimpleTableAnalysisTask")
...
class SimpleTableAnalysisConfig(AnalysisBaseConfig, pipelineConnections=SimpleTableAnalysisConnections):
...
class SimpleTableAnalysisTask(AnalysisPipelineTask):
    """An ``AnalysisPipelineTask`` that loads a simple table and passes it
    ...
    ConfigClass = SimpleTableAnalysisConfig
    _DefaultName = "simpleTableAnalysisTask"
