...
from lsst.analysis.tools.atools.actionMagnitudeScatterPlot import SingleColumnMagnitudeScatterPlot
from lsst.analysis.tools.math import sqrt


class SingleColumnMagnitudeScatterPlotTestCase(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.action = SingleColumnMagnitudeScatterPlot(
            key_y="y",
            mag_x="cmodel_err",
        )
